...
if __name__=='__main__':
    ...
    instructions = Label(root, text = 'Type in the colour of the words, and not the word text!', font = ('Helvetica', 30))
    instructions.pack()

    #Create a Score label
    scoreLabel = Label(root, text = 'Score :'+str(score), font=('Helvetica' , 30))
    scoreLabel.pack()

    #Create a Time Label 
    timeLabel = Label(root, text = 'Time Left : '+str(time), font=('Helvetica' , 30))
    timeLabel.pack()

    #create a colour label
    colour = Label(root, font=('Helevetica',30))
    colour.pack()
